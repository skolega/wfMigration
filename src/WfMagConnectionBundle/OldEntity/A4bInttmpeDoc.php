 ...
 * A4bInttmpeDoc
 *
 * @ORM\Table(name="A4B_IntTmpE_Doc", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_Doc_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_Doc_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeDoc
{
     ...
     * @var integer
     *
     * @ORM\Column(name="DetailsCount", type="integer", nullable=true)
     */
    private $detailscount;
