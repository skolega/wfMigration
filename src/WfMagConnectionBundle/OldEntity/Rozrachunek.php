 ...
 * Rozrachunek
 *
 * @ORM\Table(name="ROZRACHUNEK", uniqueConstraints={@ORM\UniqueConstraint(name="ROZRACHUNEK_NAZWAKONTA", columns={"NAZWA_KONTA", "ID_ROZRACHUNKU"}), @ORM\UniqueConstraint(name="ROZRACHUNEK_NAZWAKONTA_DESC", columns={"NAZWA_KONTA", "ID_ROZRACHUNKU"})}, indexes={@ORM\Index(name="ROZRACHUNEK_NRKONTA", columns={"NR_KONTA"}), @ORM\Index(name="ROZRACHUNEK_IDNAGDOKF_TYPDOK", columns={"ID_NAG_DOK_F", "TYP_DOK"}), @ORM\Index(name="ROZRACHUNEK_SEMAFOR", columns={"SEMAFOR", "FLAGA_STANU"}), @ORM\Index(name="ROZRACHUNEK_IDNAGDOKM_TYPDOK", columns={"ID_NAG_DOK_M", "TYP_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDPOZDOKF_STRONA", columns={"ID_POZ_DOK_F", "STRONA"}), @ORM\Index(name="ROZRACHUNEK_IDPOZDOKM_STRONA", columns={"ID_POZ_DOK_M", "STRONA"}), @ORM\Index(name="ROZRACHUNEK_SYMBOL", columns={"SYMBOL"}), @ORM\Index(name="ROZRACHUNEK_TERMINPLATNOSCI", columns={"TERMIN_PLATNOSCI"}), @ORM\Index(name="ROZRACHUNEK_DATADOK", columns={"DATA_DOK"}), @ORM\Index(name="ROZRACHUNEK_NRDOK", columns={"NR_DOK"}), @ORM\Index(name="ROZRACHUNEK_KWOTA", columns={"KWOTA"}), @ORM\Index(name="ROZRACHUNEK_KWOTAW", columns={"KWOTA_W"}), @ORM\Index(name="ROZRACHUNEK_OPIS", columns={"OPIS"}), @ORM\Index(name="ROZRACHUNEK_AGREGAT", columns={"AGREGAT"}), @ORM\Index(name="ROZRACHUNEK_ID_APLIKACJA_STATUS", columns={"ID_ROZRACHUNKU", "APLIKACJA_STATUS"}), @ORM\Index(name="ROZRACHUNEK_IDFAKTURY", columns={"ID_FAKTURY"}), @ORM\Index(name="ROZRACHUNEK_IDZAMOWIENIA", columns={"ID_ZAMOWIENIA"}), @ORM\Index(name="ROZRACHUNEK_IDNAGDOKF", columns={"ID_NAG_DOK_F"}), @ORM\Index(name="ROZRACHUNEK_IDPOZDOKF", columns={"ID_POZ_DOK_F"}), @ORM\Index(name="ROZRACHUNEK_IDKONTRAHENTA_TYPKARTOTEKI", columns={"ID_KONTRAHENTA", "TYP_KARTOTEKI"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW1", columns={"DATA_DOK", "KIERUNEK_ZAPLATY", "CZY_ROZLICZONY", "NR_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW11", columns={"KIERUNEK_ZAPLATY", "CZY_ROZLICZONY", "NR_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW2", columns={"TERMIN_PLATNOSCI", "DATA_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW21", columns={"TERMIN_PLATNOSCI", "NR_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW3", columns={"RODZAJ", "CZY_ROZLICZONY", "NR_DOK"}), @ORM\Index(name="ROZRACHUNEK_IDXBRW31", columns={"DATA_DOK", "RODZAJ", "CZY_ROZLICZONY", "NR_DOK"})})
 * @ORM\Entity
 */
class Rozrachunek
{
