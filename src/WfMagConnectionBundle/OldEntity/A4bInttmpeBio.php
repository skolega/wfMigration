 ...
 * A4bInttmpeBio
 *
 * @ORM\Table(name="A4B_IntTmpE_BiO", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_BiO_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_BiO_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeBio
{
     ...
     * @var string
     *
     * @ORM\Column(name="IdDocumentOrderDetail", type="string", length=50, nullable=true)
     */
    private $iddocumentorderdetail;
