 ...
 * A4bInttmpeAtr
 *
 * @ORM\Table(name="A4B_IntTmpE_Atr", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_Atr_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_Atr_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeAtr
{
     ...
     * @var integer
     *
     * @ORM\Column(name="DicIndx", type="integer", nullable=true)
     */
    private $dicindx;
