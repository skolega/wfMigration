 ...
 * A4bInttmpeUsl
 *
 * @ORM\Table(name="A4B_IntTmpE_UsL", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_UsL_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_UsL_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeUsl
{
     ...
     * @var string
     *
     * @ORM\Column(name="IdUserListing", type="string", length=50, nullable=true)
     */
    private $iduserlisting;
