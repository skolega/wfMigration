 ...
 * A4bInttmpeWar
 *
 * @ORM\Table(name="A4B_IntTmpE_War", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_War_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_War_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeWar
{
     ...
     * @var string
     *
     * @ORM\Column(name="SynchronizeSymbol", type="string", length=20, nullable=true)
     */
