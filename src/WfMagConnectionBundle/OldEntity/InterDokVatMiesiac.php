 ...
 * InterDokVatMiesiac
 *
 * @ORM\Table(name="INTER_DOK_VAT_MIESIAC")
 * @ORM\Entity
 */
class InterDokVatMiesiac
{
    /**
     * @var string
     *
     * @ORM\Column(name="ID_INTER_DOK_VAT_MIESIAC", type="decimal", precision=18, scale=0, nullable=false)
     */
    private $idInterDokVatMiesiac;
