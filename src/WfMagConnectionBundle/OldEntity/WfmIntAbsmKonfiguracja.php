...
/**
 * WfmIntAbsmKonfiguracja
 *
 * @ORM\Table(name="WFM_INT_ABSM_KONFIGURACJA", uniqueConstraints={@ORM\UniqueConstraint(name="IDX_WFM_INT_ABSM_KONFIGURACJA_KOLEJNOSC_KIERUNEK", columns={"Kolejnosc", "Kierunek", "Aktywny"})})
 * @ORM\Entity
 */
class WfmIntAbsmKonfiguracja
{
    /**
     * @var integer
     *
