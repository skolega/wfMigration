...
/**
 * MagRejestrZmianStatusowOfertOpis
 *
 * @ORM\Table(name="MAG_REJESTR_ZMIAN_STATUSOW_OFERT_OPIS", uniqueConstraints={@ORM\UniqueConstraint(name="AK_MAG_REJESTR_ZMIAN_STATUSOW_OFERT_OPIS", columns={"ID_DOKUMENTU", "ID_REJESTRU_ZMIAN"})})
 * @ORM\Entity
 */
class MagRejestrZmianStatusowOfertOpis
{
    /**
     * @var string
     *
