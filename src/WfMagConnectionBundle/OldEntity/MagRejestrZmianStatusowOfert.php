...
/**
 * MagRejestrZmianStatusowOfert
 *
 * @ORM\Table(name="MAG_REJESTR_ZMIAN_STATUSOW_OFERT", uniqueConstraints={@ORM\UniqueConstraint(name="AK_MAG_REJESTR_ZMIAN_STATUSOW_OFERT", columns={"ID_DOKUMENTU", "DATAICZAS", "KOD_Z", "KOD_NA"})})
 * @ORM\Entity
 */
class MagRejestrZmianStatusowOfert
{
    /**
     * @var string
     *
