 ...
 * A4bInttmpeInp
 *
 * @ORM\Table(name="A4B_IntTmpE_InP", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_InP_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_InP_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeInp
{
     ...
     * @var string
     *
     * @ORM\Column(name="PriceDescription", type="string", length=500, nullable=true)
     */
