 ...
 * A4bInttmpePic
 *
 * @ORM\Table(name="A4B_IntTmpE_Pic", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_Pic_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_Pic_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpePic
{
     ...
     * @var string
     *
     * @ORM\Column(name="IdPic", type="decimal", precision=18, scale=0, nullable=true)
     */
    private $idpic;
