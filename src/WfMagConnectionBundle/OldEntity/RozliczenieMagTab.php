 ...
 * RozliczenieMagTab
 *
 * @ORM\Table(name="ROZLICZENIE_MAG_TAB", uniqueConstraints={@ORM\UniqueConstraint(name="ROZLICZENIE_IDROZRACHUNKU_DATAROZLICZENIA_ID", columns={"ID_ROZRACHUNKU", "DATA_ROZLICZENIA", "ID_ROZLICZENIA"}), @ORM\UniqueConstraint(name="ROZLICZENIE_IDROZR_STRONA_KWOTA_ID_RZL", columns={"ID_ROZRACHUNKU", "STRONA", "KWOTA", "ID_ROZLICZENIA"}), @ORM\UniqueConstraint(name="ROZLICZENIE_IDROZR_STRONA_KWOTA_W_ID_RZL", columns={"ID_ROZRACHUNKU", "STRONA", "KWOTA_W", "ID_ROZLICZENIA"})}, indexes={@ORM\Index(name="ROZLICZENIE_IDROZRACHUNKU", columns={"ID_ROZRACHUNKU"}), @ORM\Index(name="ROZLICZENIE_IDROZRACHUNKUZWIAZEK", columns={"ID_ROZRACHUNKU_ZWIAZEK"}), @ORM\Index(name="ROZLICZENIE_ID_POZ_DOK_M", columns={"ID_POZ_DOK_M"})})
 * @ORM\Entity
 */
class RozliczenieMagTab
{
    /**
     * @var string
     *
