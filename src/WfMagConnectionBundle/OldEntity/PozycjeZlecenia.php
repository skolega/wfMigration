 ...
 * PozycjeZlecenia
 *
 * @ORM\Table(name="POZYCJE_ZLECENIA", indexes={@ORM\Index(name="POZYCJE_ZLECENIA_IDZ_IDA", columns={"ID_ZLECENIA", "ID_ARTYKULU"}), @ORM\Index(name="POZYCJE_ZLECENIA_IDZ_STATUS", columns={"ID_ZLECENIA", "STATUS"})})
 * @ORM\Entity
 */
class PozycjeZlecenia
{
    /**
     * @var string
     *
