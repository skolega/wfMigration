 ...
 * A4bInttmpeAtv
 *
 * @ORM\Table(name="A4B_IntTmpE_AtV", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_AtV_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_AtV_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpeAtv
{
     ...
     * @var integer
     *
     * @ORM\Column(name="IdAtrType", type="integer", nullable=true)
     */
    private $idatrtype;
     ...
     * @var integer
     *
     * @ORM\Column(name="AtrDicIndx", type="integer", nullable=true)
     */
    private $atrdicindx;
