 ...
 * A4bInttmpePrr
 *
 * @ORM\Table(name="A4B_IntTmpE_PrR", indexes={@ORM\Index(name="IDX_A4B_IntTmpE_PrR_RecordStatus_IdSession", columns={"A4BSystemUniqueId", "IdRecord", "IdRecordSource", "IdRecordHeader", "RecordCreateDate", "RecordProcessDate", "TransmissionGUID", "MessageId", "RecordStatus", "IdSession"}), @ORM\Index(name="IDX_A4B_IntTmpE_PrR_RecordStatus_RecordProcessDate", columns={"IdSession", "RecordStatus", "RecordProcessDate"})})
 * @ORM\Entity
 */
class A4bInttmpePrr
{
     ...
     * @var string
     *
     * @ORM\Column(name="IdProductRelated", type="string", length=50, nullable=true)
     */
    private $idproductrelated;

    /**
     * @var string
     *
     * @ORM\Column(name="RelationType", type="string", length=30, nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="Bidirectional", type="integer", nullable=true)
     */
