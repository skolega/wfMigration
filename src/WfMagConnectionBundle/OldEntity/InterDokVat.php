 ...
 * InterDokVat
 *
 * @ORM\Table(name="INTER_DOK_VAT", indexes={@ORM\Index(name="PO_DATA_VAT", columns={"DATA_VAT"}), @ORM\Index(name="WG_ID_DOKUMENTU_HANDLOWEGO", columns={"ID_DOKUMENTU_HANDLOWEGO"}), @ORM\Index(name="WG_ID_DOK_MAGAZYNOWEGO", columns={"ID_DOK_MAGAZYNOWEGO", "SPRZEDAZ", "ZAKUP"})})
 * @ORM\Entity
 */
class InterDokVat
{
